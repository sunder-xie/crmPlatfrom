			...
			.datagrid(
					{
						...
						title : '查询结果',
						url : appUrl
								+ '/goal/goalAction!searchGoalSalesChangeListJson.jspa',
						loadMsg : '数据远程载入中,请等待...',
						singleSelect : false,
						rownumbers:true,
						pagination : true,
...
function look(id){
	initMaintWindow('调整信息',
			appUrl + '/goal/goalAction!toGoalSalesChangeView.jspa?changeId='
					+ id, 'maintWindow', '1000', '450', true);
}

function add(){
	initMaintWindow('调整信息',
			appUrl + '/goal/goalAction!toGoalSalesChange.jspa', 
...
function excel() {
	...
	form.action = appUrl + '/goal/goalAction!exportForExcelGoalSalesChange.jspa';
