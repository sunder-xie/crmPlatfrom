$(document).ready(function() {
	...
	loadKunnr();
	$('#kunnr').combogrid("setValue",$('#defaultKunnr').val());
	$('#kunnr').combogrid("setText",$('#defaultKunnrName').val());
	$('#orderState').combobox("setValue",$('#defaultState').val());
	loadGrid();
	getSum();
});
...
function getSum(){
	$.ajax({
		...
		data : {
			kunagId : $('#kunnr').combogrid("getValue"),
			orgId : $('#orgId').val(),
		    skuId : $('#skuId').combogrid("getValue"),
		    categoryId : $('#categoryId').combogrid("getValue"),
...
function search() {
	...
	queryParams.kunagId = $('#kunnr').combogrid("getValue");
