...
function createOrder() {
	...
	form.action = appUrl + "/order/orderAction!createOrder.jspa";
...
function addDetail(){
	...
	$("#detailList").append('<table width="100%" border="0" id="detail_'+detailId+'">'+
		                     ...
		                     '<td >'+
			                 '<input type="text" size="4"  id="price_'+detailId+'" name="prices" class="easyui-validatebox"'+
                             'onblur="calcu('+detailId+')">'+
		                     '</td>'+
                             '<td class="head" nowrap>数量：</td>'+
                             '<td >'+
                             '<input type="text" size="4" id="quantity_'+detailId+'" name="quantitys" class="easyui-validatebox"onblur="calcu('+detailId+')">'+
                             '</td>'+
                             '<td class="head" nowrap>总价：</td>'+
                             '<td >'+
                             '<input type="text" size="5" id="totalPriceDetail_'+detailId+'" name="totalPriceDetails" class="easyui-validatebox"readonly="true">'+
                             '</td>'+
