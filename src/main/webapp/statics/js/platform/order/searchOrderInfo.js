			...
			.datagrid(
					{
						...
						striped : true,
						url : appUrl
								+ '/orderAction!searchOrderInfo.jspa',
...
function search() {
	...
	queryParams.stationName = $('#stationName').combobox("getValue");
...
function selectOrgTree() {
	initMaintWindow('选择组织', '/visitInfo/visitInfoAction!orgTreePage.jspa', 400, 460);
}
...
function printView(orderId){
	...
	window.open(appUrl + '/financialCheck/orderAction!toPrintOrder.jspa?orderId='+orderId, "订单信息",
