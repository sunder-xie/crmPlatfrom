function getVisitInfo() {
	...
	form.action = appUrl
			+ '/visitInfo/visitInfoAction!searchVisitInfo.jspa';
			...
			.datagrid(
					{
						iconCls : 'icon-list',
						title : '拜访列表',		
						url : appUrl + '/visitInfo/visitInfoAction!searchVisitInfoUser.jspa',
						loadMsg : '数据远程载入中,请等待...',
						singleSelect : false,
						pagination : true,
						nowrap : true,
...
function exportForExcel() {
	...
	var form = window.document.forms[0];
	form.action = appUrl
			+ '/visitInfo/visitInfoAction!exportForVisitInfoUser.jspa';
	form.target = "hideFrame";
	form.submit();
}
function openTime() {
