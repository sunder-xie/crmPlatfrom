...
function addAcount() {
	...
	html += '&nbsp;&nbsp;年返(元):<input class="easyui-numberbox" style="width:60px" id="typeC_'
			+ acountCount + '">'
			+'&nbsp;协议价(元):<input class="easyui-numberbox" id="typeMoney_'+ acountCount + '" onchange="changeRow('+acountCount+')"  style="width:60px"></td>';
	if ($('#konzs').val()) {
	...
	html += '<tr id="salesAcountTr_' + acountCount + '">';
	html += '<td class="head" noWrap>(SAP协议号)月返:<input class="easyui-validatebox" id="text0_'
			+ trCount + '" validType="length[0,20]">';
	html += '<td noWrap><font style="font-weight:bold;color:#006b8a">季返:<input class="easyui-validatebox" id="text01_'
		        + trCount + '" validType="length[0,20]">年返:<input class="easyui-validatebox" id="text02_'
		        + trCount + '" validType="length[0,20]">&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;开始生效日期:</font></td>';
	html += '<td  noWrap><div><font style="font-weight:bold;color:#006b8a">'
			+ '<input class="easyui-datebox" id="text1_' + trCount
			+ '" data-options="editable:false">';
	html += '&nbsp;有效截止日期:</font><input class="easyui-datebox" id="text2_'
