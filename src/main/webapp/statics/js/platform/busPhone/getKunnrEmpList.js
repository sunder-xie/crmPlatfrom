			...
			.datagrid(
					{
						...
						striped : true,
						url : appUrl
								+ '/busPhoneAction!getKunnrEmpList.jspa',
...
function clear(userId){
	$.messager.confirm('Confirm','是否删除?',function(r) {
		if (r) {
			$.ajax({
				type : "post",
				url : appUrl + "/busPhoneAction!deleteKunnrEmp.jspa",
				data : {
					userId : userId
				},
...
function saverow(target) {
	...
	$.ajax({
		type : "post",
		url : appUrl + "/busPhoneAction!updateKunnrEmp.jspa",
		data : {
...
function exportForExcel() {
	...
	form.action = appUrl
			+ '/busPhoneAction!exportKunnrEmpToExcel.jspa';
