...
public class KunnrB extends SearchInfo {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5572342477626479L;
	private Long id;
	...
	private List<KunnrBusinessC> kunnrbusinessList;// 详细信息
	private List<BCustomerTarget> targetList;  //目标量
	...
	private String shXzAddress;     //收货行政区划描述
	
	private String bgXzAddress;    //办公行政区划描述：省+市+区+镇
	
	private String codeSales;      //销售视图下的省市后两位编号拼的字符串
	private String eventId;        //事务号
	
	private Integer staffNumber;      //经销商雇员编制数量
	private Integer staffNumberY;     //经销商雇员已占编制数量
	...
	public List<KunnrBusinessC> getKunnrbusinessList() {
		return kunnrbusinessList;
	}

	public void setKunnrbusinessList(List<KunnrBusinessC> kunnrbusinessList) {
