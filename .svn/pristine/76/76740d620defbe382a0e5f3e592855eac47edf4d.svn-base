package com.kintiger.platform.distributionData.pojo;
 ...
 * 
 */
public class DistributionData extends SearchInfo implements Serializable {
	...
	private String matter;//预算口径代码A1 A2 A3
	private String matterNum;//物料编号 10900001
