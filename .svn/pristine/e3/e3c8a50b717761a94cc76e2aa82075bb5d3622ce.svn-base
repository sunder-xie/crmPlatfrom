			...
			.datagrid(
					{
						iconCls : 'icon-list',
						title : '库存列表',		
						url : appUrl + '/stockReport/stockReportAction!searchStockCheck.jspa',
						loadMsg : '数据远程载入中,请等待...',
						singleSelect : false,
						pagination : true,
						nowrap : true,
...
function search() {
	...
	queryParams.stockFlag = $('#stockFlag').combobox("getValue");
...
function exportForExcel() {
	...
	form.action = appUrl
			+ '/stockReport/stockReportAction!exportForExcelCheck.jspa';
