			...
			.datagrid(
					{
						...
						title : '查询结果',
						url : appUrl
								+ '/distributionDataAppendAction!getDistributionDataAppendList.jspa',
						loadMsg : '数据远程载入中,请等待...',
						singleSelect : false,
						pagination : true,
						nowrap : true,
...
// excel导出
function exportDistributionDataAppend() {
	var form = window.document.forms[0];
	form.action = appUrl
			+ '/distributionDataAppendAction!exportDistributionDataAppend.jspa';
	form.submit();
	$.messager.alert('Tips', '正在导出,请稍候!', 'warning');
}

function closeDtPlan() {
	$("#MaintDistributionDataAppend").window('close');
}

function initMaintDistributionDataAppend(title, url, WWidth, WHeight) {
	var url = appUrl + url;
	var $win = $("#MaintDistributionDataAppend")
			.window(
					{
						title : title,
						width : WWidth,
...
function updateDistributionDataAppend(ctId) {//
						...
						buttons : [
								{
									...
									handler : function() {
										...
										if (/^.+\.(csv|CSV)$/.test(file)) {
											...
											var action = '';
											action = appUrl
													+ "/distributionDataAppend/distributionDataAppendAction!importDistributionDataAppendCsv.jspa";
											var form = document
...
function selectOrgTree() {
	initMaintDistributionDataAppend('选择组织',
			'/distributionDataAppendAction!orgTreePage.jspa', 400, 460);
}
...
function importMatterModel() {
	var form = window.document.forms[0];
	form.action = appUrl
			+ '/distributionDataAppend/distributionDataAppendAction!importDistributionDataAppendModel.jspa';
	form.target = "hideFrame";
	form.submit();
}

function deleteDistributionDataAppend() {
	...
	$("#ids").val(ids);
	var form = window.document.forms[0];
	form.action = "distributionDataAppendAction!deleteDistributionDataAppend.jspa";
	form.target = "hideFrame";
	form.submit();
...
function saverow(target) {
	...
	var form = window.document.forms[0];
	form.action = "distributionDataAppendAction!updateDistributionDataAppend.jspa";
	form.target = "hideFrame";
	form.submit();
}
...
function exportMould() {
	var form = window.document.forms[0];
	form.action = appUrl
			+ '/distributionDataAppend/distributionDataAppendAction!exportMouldCsv.jspa';
	form.target = "hideFrame";
	form.submit();
}
