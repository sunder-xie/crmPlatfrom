			...
			.datagrid(
					{
						...
						title : '查询结果',
						url : appUrl
								+ '/distributionDataAppendRepMonAction!getDistributionDataAppendRepMonList.jspa',
						loadMsg : '数据远程载入中,请等待...',
						singleSelect : false,
						pagination : true,
						nowrap : true,
						...
						toolbar : [
								/*"-",
								{
									...
									iconCls : 'icon-remove',
									handler : function() {
										deleteDistributionDataAppendRep();
									}
								},
								"-",
								{
								...
								"-",
								{
									...
									iconCls : 'icon-add',
									handler : function() {
										importDistributionDataAppendRep();
									}
								},*/
								"-",
								{
									...
									handler : function() {
										exportDistributionDataAppendRepMon();
									}
								},
								"-",
								{
...
// excel导出
function exportDistributionDataAppendRepMon() {
	var form = window.document.forms[0];
	form.action = appUrl
			+ '/distributionDataAppendRepMonAction!exportDistributionDataAppendRepMon.jspa';
	form.submit();
	$.messager.alert('Tips', '正在导出,请稍候!', 'warning');
}

function closeDtPlan() {
	$("#MaintDistributionDataAppendRepMon").window('close');
}

function initMaintDistributionDataAppendRepMon(title, url, WWidth, WHeight) {
	var url = appUrl + url;
	var $win = $("#MaintDistributionDataAppendRepMon")
			.window(
					{
						title : title,
						width : WWidth,
...
function updateDistributionDataAppendRepMon(ctId) {//
	var ctId = encodeURIComponent(ctId);
	var mark = encodeURIComponent(mark);
	initMaintDataAppend('目标数修改',
			'/goalAction!updateDataAppendRepMonPrepare.jspa?ctId=' + ctId + '&mark'
					+ mark, 490, 400);
}

function importDistributionDataAppendRepMon() {
						...
						buttons : [
								{
									...
									handler : function() {
										...
										if (/^.+\.(csv|CSV)$/.test(file)) {
											...
											var action = '';
											action = appUrl
													+ "/distributionDataAppendRepMon/distributionDataAppendRepMonAction!importDistributionDataAppendRepMonCsv.jspa";
											var form = document
...
function selectOrgTree() {
	initMaintDistributionDataAppendRepMon('选择组织',
			'/distributionDataAppendRepMonAction!orgTreePage.jspa', 400, 460);
}
...
function importMatterModel() {
	var form = window.document.forms[0];
	form.action = appUrl
			+ '/distributionDataAppendRepMon/distributionDataAppendRepMonAction!importDistributionDataAppendRepMonModel.jspa';
	form.target = "hideFrame";
	form.submit();
}

function deleteDistributionDataAppendRepMon() {
	...
	$("#ids").val(ids);
	var form = window.document.forms[0];
	form.action = "distributionDataAppendRepMonAction!deleteDistributionDataAppendRepMon.jspa";
	form.target = "hideFrame";
	form.submit();
...
function saverow(target) {
	...
	var form = window.document.forms[0];
	form.action = "distributionDataAppendRepMonAction!updateDistributionDataAppendRepMon.jspa";
	form.target = "hideFrame";
	form.submit();
}
...
function exportMould() {
	var form = window.document.forms[0];
	form.action = appUrl
			+ '/distributionDataAppendRepMon/distributionDataAppendRepMonAction!exportMouldCsv.jspa';
	form.target = "hideFrame";
	form.submit();
}
...
function updateDataAppendRepMonList() {
	html = '<form id="fileForm" method="post" enctype="multipart/form-data" >'
			+ '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp'
			+ '<table><tr>'
