	...
	$('#datagrid')
			.datagrid(
					  {    
						iconCls : 'icon-list',
						title : '入库单明细',
						url :appUrl + '/stock/instockAction!getInStockDetailListByTotalId1.jspa',
								queryParams: {
...
function search() {
  ...
  //  alert(($("#finishTime1").val()));
	queryParams.instock_total_id = encodeURIComponent($("#instock_total_id").val());
